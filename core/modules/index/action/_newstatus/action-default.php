...
?>
        ...
        <div class="panel panel-default" style="background-color: #3f3f44">
...
<form role="form" id="status" enctype="multipart/form-data" method="post" action="./?action=publish">
  <div class="form-group">
    <textarea rows="2" name="content" id="statusarea" class="form-control" placeholder="Escribe algo? Vamos."></textarea>
...
<div class="col-md-4" style="background-color: #3f3f44">
<!--  <button type="button" id="publish" class="btn btn-primary btn-block">Publicar</button>-->
  <button type="submit" id="publish" class="btn btn-primary btn-block" style="background-color: #f4efd3">Publicar</button>
  </div>
