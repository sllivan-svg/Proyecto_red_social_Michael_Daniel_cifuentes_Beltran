...
<form role="form" id="status" enctype="multipart/form-data" method="post" action="./?action=publishteam">
  <div class="form-group">
    <textarea rows="2" name="content" id="statusarea" class="form-control" placeholder="Publicar Estado"></textarea>
    <input type="hidden" name="receptor_type_id" value="2">
    <input type="hidden" name="receptor_ref_id" value="<?php echo $_GET["id"];?>">
  </div>
<div class="buttons">
  <div class="form-group">
  <div class="row">
