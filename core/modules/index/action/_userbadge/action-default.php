...
?>
<div class="well" style="background-color: #3f3f44">
<div class="row">
<div class="col-md-4" >
...
<a href="./?view=editinformation" style="background-color: #cccccc" class="btn btn-default btn-xs">Editar Informacion</a>
<?php else:
